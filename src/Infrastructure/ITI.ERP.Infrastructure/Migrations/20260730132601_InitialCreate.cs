        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GRNumber = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    SessionYear = table.Column<string>(type: "character varying(9)", maxLength: 9, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AcademicSessions_Institutes_InstituteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_AcademicSessions_AcademicSessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trades_Users_HeadUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_InstituteId_Timestamp",
                table: "AuditLogs",
                columns: new[] { "InstituteId", "Timestamp" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Roles_InstituteId_Name",
                table: "Roles",
                columns: new[] { "InstituteId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Trades_AcademicSessionId",
                table: "Trades",
                column: "AcademicSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_Trades_HeadUserId",
                table: "Trades",
                column: "HeadUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_AcademicSessionId",
                table: "UserRoles",
                column: "AcademicSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_InstituteId",
                table: "UserRoles",
                column: "InstituteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_AcademicSessionId",
                table: "Users",
                column: "AcademicSessionId");
