        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PasswordResetTokens_Institutes_InstituteId",
                        column: x => x.InstituteId,
                        principalTable: "Institutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PasswordResetTokens_Users_InitiatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_InitiatedByUserId",
                table: "PasswordResetTokens",
                column: "InitiatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetTokens_InstituteId",
                table: "PasswordResetTokens",
                column: "InstituteId");
