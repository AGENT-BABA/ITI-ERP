...
{
    Task<Result<PaginatedList<BatchDto>>> GetBatchesAsync(Guid? instituteId, Guid? tradeId, Guid? academicSessionId, PaginationRequest request, CancellationToken ct);
